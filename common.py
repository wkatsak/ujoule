...
class ujouleLouieSignals(object):
	...
	SIGNAL_HEAT_ON_CHANGED				= UJOULE_LOUIE_SIGNAL_MAGIC | 1024
	SIGNAL_HEAT_ON_UPDATED				= UJOULE_LOUIE_SIGNAL_MAGIC | 2048
	SIGNAL_FAN_ON_CHANGED				= UJOULE_LOUIE_SIGNAL_MAGIC | 4096
	SIGNAL_FAN_ON_UPDATED				= UJOULE_LOUIE_SIGNAL_MAGIC | 8192
